...
const Navbar = () => {
  ...
  return (
    <section className='fixed w-full h-[5rem] flex justify-between items-center px-4 bg-[#0a192f]
     text-gray-300'>
        <div className="">
        ...
        {/* Mobile Menu */}
        {nav ? <ul className={`${!nav ? 'hidden' : 'absolute top-0 left-0 h-screen bg-[#0a192f] flex flex-col justify-center items-center w-full'}`}>
